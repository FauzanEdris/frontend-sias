<template>
  <div>
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <b-nav-item-dropdown text="User" right>
            <b-dropdown-item to="/admin/admin">
              Admin
            </b-dropdown-item>
            <b-dropdown-item to="/admin/operator">
              Operator
            </b-dropdown-item>
            <b-dropdown-item to="/admin/dosen">
              Dosen
            </b-dropdown-item>
            <b-dropdown-item to="/admin/asdos">
              Asisten Dosen
            </b-dropdown-item>
            <b-dropdown-item to="/admin/akademik">
              bag. Akademik
            </b-dropdown-item>
            <b-dropdown-item to="/admin/keuangan">
              bag. Keuangan
            </b-dropdown-item>
          </b-nav-item-dropdown>
        </b-navbar-nav>
    ...
    <b-navbar toggleable="lg" type="light" class="navbar2">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          <b-nav-item to="/operator">
            Home
          </b-nav-item>
          <b-nav-item to="/operator/profil">
            Profil
          </b-nav-item>
          <b-nav-item to="/operator/pendaftaran">
            Pendaftaran
          </b-nav-item>
          <b-nav-item to="/operator/jadwal">
            Jadwal
          </b-nav-item>
        </b-navbar-nav>
        <!-- <b-nav-form right>
