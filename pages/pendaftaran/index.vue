<template>
  <div>
    <b-form
      id="formPendaftaran"
      ref="form"
      @submit.prevent="$parent.daftar({status: 'Mahasiswa', form})"
      autocomplete="off>
      ...
      n-i-m-
      label="NIM :"
      label-for="form-id_user"
    >
      <b-form-group invalid-feedback="Harap Isi NIM" label="NIM :" label-for="form-nim">
        <b-form-input
          ref="id_user"
          v-model="form.id"
          type="number"
      ...
      <b-form-group invalid-feedback="Harap Isi Transkip Nilai" label="Transkip :" label-for="form-transkip">
        <b-form-file
          ref="transkip"
          v-model="form.transkip"
